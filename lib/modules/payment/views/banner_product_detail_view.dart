...
class BannerProductDetailView extends StatefulWidget {
  ...
  @override
  State<BannerProductDetailView> createState() => _BannerProductDetailViewState();
}
...
class _BannerProductDetailViewState extends State<BannerProductDetailView> {
  ...
  void _updateCountdown(DateTime target) {
    ...
    setState(() {
      if (days > 0) {
        _countdownText = 'Offer ends in ${days}d ${hours}h ${minutes}m ${seconds}s';
      } else if (hours > 0) {
  ...
  Future<void> _loadData() async {
    ...
    if (widget.banner.linkType != null && widget.banner.linkId != null) {
      futures.add(_paymentController.checkExistingRequest(
        ...
        children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (banner.planDescription != null && banner.planDescription!.isNotEmpty) ...[
                          Text(
                            'Plan Description',
          ...
          Obx(() {
            ...
            if (_isEnrolled) {
              ...
              final isLinkValid = widget.banner.linkType != null && widget.banner.linkId != null;
              buttonAction = () {
                if (!isLinkValid) {
                  AppToast.error('This product is not available for purchase (missing link configuration).');
                } else {
